...
First, the framework currently uses a single SAA realisation; a multi-scenario
SAA (10--30~realisations) would provide confidence intervals on the Pareto front
at the cost of longer computation.  Second, the addition of a resource-levelling
