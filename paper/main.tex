...
Mediterranean conditions --- the algorithm eliminates all tardiness penalties
(saving~\euro36,500) while reducing water violations by up to~19.4\% relative to
a naive, water-unaware baseline schedule.  The marginal cost of water-quota compliance is
directly readable from the trade-off curve (approximately \euro14.85 per m$^3$
under mild drought), providing a concrete input for contract negotiations and
regulatory planning.  Under severe drought, a structural collapse of the trade-off
